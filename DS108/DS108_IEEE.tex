...
\caption{Hurdle model: scatter predicted vs.\ actual return magnitude.
Hàng trên: Corn Daily. Hàng dưới: Coffee Daily. Cột (a)~Stage~2a --- Up
trades (predicted upside vs.\ actual positive return). Cột (b)~Stage~2b ---
Down trades (predicted magnitude vs.\ $|\text{actual return}|$; Corn Daily
$r{=}{+}0.371$, $p{<}0.0001$, $n{=}164$). Cột (c)~Full hurdle combined
(signed prediction vs.\ actual return). Đường thẳng: hồi quy OLS; sao:
